...
{
    private static final /* synthetic */ String[] ID_MAP;
    
    @Override
    public NBTTagCompound fixTagCompound(final NBTTagCompound llllllllllllllllllIllIIIlIIIIlll) {
        if (llllllllllllllllllIllIIIlIIIIlll.hasKey("id", 99)) {
            final short llllllllllllllllllIllIIIlIIIIllI = llllllllllllllllllIllIIIlIIIIlll.getShort("id");
            if (llllllllllllllllllIllIIIlIIIIllI > 0 && llllllllllllllllllIllIIIlIIIIllI < ItemIntIDToString.ID_MAP.length && ItemIntIDToString.ID_MAP[llllllllllllllllllIllIIIlIIIIllI] != null) {
                llllllllllllllllllIllIIIlIIIIlll.setString("id", ItemIntIDToString.ID_MAP[llllllllllllllllllIllIIIlIIIIllI]);
            }
        }
        return llllllllllllllllllIllIIIlIIIIlll;
    }
    
    static {
        (ID_MAP = new String[2268])[1] = "minecraft:stone";
