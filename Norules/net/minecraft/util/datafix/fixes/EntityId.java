...
{
    private static final /* synthetic */ Map<String, String> field_191276_a;
    ...
    static {
        (field_191276_a = Maps.newHashMap()).put("AreaEffectCloud", "minecraft:area_effect_cloud");
    ...
    @Override
    public NBTTagCompound fixTagCompound(final NBTTagCompound lllllllllllllIIlIlIIlllIIIlIIIll) {
        final String lllllllllllllIIlIlIIlllIIIlIIlII = EntityId.field_191276_a.get(lllllllllllllIIlIlIIlllIIIlIIIll.getString("id"));
        if (lllllllllllllIIlIlIIlllIIIlIIlII != null) {
            lllllllllllllIIlIlIIlllIIIlIIIll.setString("id", lllllllllllllIIlIlIIlllIIIlIIlII);
        }
        return lllllllllllllIIlIlIIlllIIIlIIIll;
    }
}
