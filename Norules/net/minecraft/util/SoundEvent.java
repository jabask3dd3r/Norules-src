...
{
    private final /* synthetic */ ResourceLocation soundName;
    private static /* synthetic */ int soundEventId;
    public static final /* synthetic */ RegistryNamespaced<ResourceLocation, SoundEvent> REGISTRY;
    ...
    public SoundEvent(final ResourceLocation lllllllllllllIIlllIlIIlIIIllllll) {
        this.soundName = lllllllllllllIIlllIlIIlIIIllllll;
    }
    
    private static void registerSound(final String lllllllllllllIIlllIlIIlIIIIlllII) {
        final ResourceLocation lllllllllllllIIlllIlIIlIIIIllIlI = new ResourceLocation(lllllllllllllIIlllIlIIlIIIIlllII);
        SoundEvent.REGISTRY.register(SoundEvent.soundEventId++, lllllllllllllIIlllIlIIlIIIIllIlI, new SoundEvent(lllllllllllllIIlllIlIIlIIIIllIlI));
    }
    
    static {
        REGISTRY = new RegistryNamespaced<ResourceLocation, SoundEvent>();
    }
}
