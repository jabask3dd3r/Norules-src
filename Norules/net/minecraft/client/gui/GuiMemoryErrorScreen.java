...
public class GuiMemoryErrorScreen extends GuiScreen
{
    ...
    @Override
    protected void keyTyped(final char lllllllllllllIllIIIIIIlIIllIlIlI, final int lllllllllllllIllIIIIIIlIIllIlIIl) throws IOException {
    }
    
    @Override
    public void drawScreen(final int lllllllllllllIllIIIIIIlIIllIIIll, final int lllllllllllllIllIIIIIIlIIlIllllI, final float lllllllllllllIllIIIIIIlIIlIlllIl) {
        ...
        super.drawScreen(lllllllllllllIllIIIIIIlIIllIIIll, lllllllllllllIllIIIIIIlIIlIllllI, lllllllllllllIllIIIIIIlIIlIlllIl);
    }
    
    @Override
    protected void actionPerformed(final GuiButton lllllllllllllIllIIIIIIlIIllIllII) throws IOException {
        if (lllllllllllllIllIIIIIIlIIllIllII.id == 0) {
            this.mc.displayGuiScreen(new GuiMainMenu());
        }
        else if (lllllllllllllIllIIIIIIlIIllIllII.id == 1) {
            this.mc.shutdown();
        }
    }
}
