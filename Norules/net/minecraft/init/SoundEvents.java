...
{
    private static SoundEvent getRegisteredSoundEvent(final String llllllllllllIlllllIIIIlllllIllll) {
        final SoundEvent llllllllllllIlllllIIIIllllllIIII = SoundEvent.REGISTRY.getObject(new ResourceLocation(llllllllllllIlllllIIIIlllllIllll));
        if (llllllllllllIlllllIIIIllllllIIII == null) {
            throw new IllegalStateException(String.valueOf(new StringBuilder("Invalid Sound requested: ").append(llllllllllllIlllllIIIIlllllIllll)));
        }
        return llllllllllllIlllllIIIIllllllIIII;
    }
