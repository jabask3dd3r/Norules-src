...
{
    @Override
    protected EntityType getObjectTypeFromId(final int lllllllllllllllllllIllIIIlllllll) {
        return Entity1_11Types.getTypeFromId(lllllllllllllllllllIllIIIlllllll, true);
    }
    
    public EntityPackets1_11_1(final Protocol1_11To1_11_1 lllllllllllllllllllIllIIlIIIllII) {
        super(lllllllllllllllllllIllIIlIIIllII);
    }
    
    @Override
    public EntityType typeFromId(final int lllllllllllllllllllIllIIlIIIIIll) {
        return Entity1_11Types.getTypeFromId(lllllllllllllllllllIllIIlIIIIIll, false);
    }
    ...
    protected void registerPackets() {
        ((AbstractProtocol<ClientboundPackets1_9_3, C2, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_9_3.SPAWN_ENTITY, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(LegacyEntityRewriter.this.getObjectRewriter(llllllllllllllIlIlIIlIIIIIIllIll -> Entity1_11Types.ObjectType.findById(llllllllllllllIlIlIIlIIIIIIllIll).orElse(null)));
            }
        });
