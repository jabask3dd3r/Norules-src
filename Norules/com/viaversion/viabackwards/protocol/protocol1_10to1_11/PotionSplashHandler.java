...
{
    private static final /* synthetic */ Int2IntMap DATA;
    
    public static int getOldData(final int llllllllllllllllIIlIlIIIlIllIIll) {
        return PotionSplashHandler.DATA.get(llllllllllllllllIIlIlIIIlIllIIll);
    }
