...
{
    private static final /* synthetic */ Int2IntMap MAPPINGS;
    
    public static int getMappedColor(final int llllllllllllllIllIIllIllllIlIllI) {
        return MapColorRewrites.MAPPINGS.getOrDefault(llllllllllllllIllIIllIllllIlIllI, -1);
    }
