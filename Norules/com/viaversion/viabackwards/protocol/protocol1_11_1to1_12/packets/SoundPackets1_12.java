...
{
    public SoundPackets1_12(final Protocol1_11_1To1_12 lllllllllllllIIllIllIIIllIlIIIIl) {
        super(lllllllllllllIIllIllIIIllIlIIIIl);
    }
    
    @Override
    protected void registerPackets() {
        ((AbstractProtocol<ClientboundPackets1_12, C2, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_12.NAMED_SOUND, new PacketRemapper() {
            @Override
        ...
        ((AbstractProtocol<ClientboundPackets1_12, C2, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_12.SOUND, new PacketRemapper() {
            @Override
            public void registerMap() {
                this.map(Type.VAR_INT);
                this.map(Type.VAR_INT);
                ...
                this.handler(new PacketHandler() {
                    @Override
                    public void handle(final PacketWrapper lllllllllllllIlIlIIllllIllIlIlII) throws Exception {
                        final int lllllllllllllIlIlIIllllIllIlIlll = lllllllllllllIlIlIIllllIllIlIlII.get((Type<Integer>)Type.VAR_INT, 0);
                        final int lllllllllllllIlIlIIllllIllIlIllI = SoundPackets1_12.this.handleSounds(lllllllllllllIlIlIIllllIllIlIlll);
                        if (lllllllllllllIlIlIIllllIllIlIllI == -1) {
                            lllllllllllllIlIlIIllllIllIlIlII.cancel();
                            return;
                        }
                        if (SoundPackets1_12.this.hasPitch(lllllllllllllIlIlIIllllIllIlIlll)) {
                            lllllllllllllIlIlIIllllIllIlIlII.set(Type.FLOAT, 1, SoundPackets1_12.this.handlePitch(lllllllllllllIlIlIIllllIllIlIlll));
                        }
                        lllllllllllllIlIlIIllllIllIlIlII.set(Type.VAR_INT, 0, lllllllllllllIlIlIIllllIllIlIllI);
                    }
                });
            }
        });
