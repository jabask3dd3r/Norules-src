...
{
    private static final /* synthetic */ Map<String, String> advancements;
    
    private static void add(final String lllllllllllllIIIIlllIIIlIllllIII, final String lllllllllllllIIIIlllIIIlIlllIlll) {
        AdvancementTranslations.advancements.put(lllllllllllllIIIIlllIIIlIllllIII, lllllllllllllIIIIlllIIIlIlllIlll);
    }
    
    static {
        advancements = new HashMap<String, String>();
    ...
    public static String get(final String lllllllllllllIIIIlllIIIlIlllIIll) {
        return AdvancementTranslations.advancements.get(lllllllllllllIIIIlllIIIlIlllIIll);
    }
}
