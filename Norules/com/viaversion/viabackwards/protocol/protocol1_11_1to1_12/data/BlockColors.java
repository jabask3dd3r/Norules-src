...
{
    private static final /* synthetic */ String[] COLORS;
    
    public static String get(final int llllllllllllllIllllIllllIIIlllII) {
        return (llllllllllllllIllllIllllIIIlllII >= 0 && llllllllllllllIllllIllllIIIlllII < BlockColors.COLORS.length) ? BlockColors.COLORS[llllllllllllllIllllIllllIIIlllII] : "Unknown color";
    }
