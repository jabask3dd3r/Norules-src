...
{
    private static final /* synthetic */ Int2IntMap MAPPING;
    
    static {
        (MAPPING = new Int2IntOpenHashMap(64, 1.0f)).defaultReturnValue(-1);
    ...
    public static int getNearestOldColor(final int lllllllllllllIllllIIlllIIIllIIll) {
        return MapColorMapping.MAPPING.getOrDefault(lllllllllllllIllllIIlllIIIllIIll, lllllllllllllIllllIIlllIIIllIIll);
    }
}
