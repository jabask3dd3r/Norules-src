...
public class Protocol1_15To1_14_4 extends AbstractProtocol<ClientboundPackets1_14, ClientboundPackets1_15, ServerboundPackets1_14, ServerboundPackets1_14>
{
    ...
    protected void onMappingDataLoaded() {
        final int[] llllllllllllllIIIIIIllIlIlIIIlII = new int[17];
        final int llllllllllllllIIIIIIllIlIlIIIIll = 501;
        for (int llllllllllllllIIIIIIllIlIlIIIllI = 0; llllllllllllllIIIIIIllIlIlIIIllI < 17; ++llllllllllllllIIIIIIllIlIlIIIllI) {
            llllllllllllllIIIIIIllIlIlIIIlII[llllllllllllllIIIIIIllIlIlIIIllI] = llllllllllllllIIIIIIllIlIlIIIIll + llllllllllllllIIIIIIllIlIlIIIllI;
        }
        this.tagRewriter.addTag(RegistryType.BLOCK, "minecraft:shulker_boxes", llllllllllllllIIIIIIllIlIlIIIlII);
    }
    ...
    protected void registerPackets() {
        ...
        final SoundRewriter llllllllllllllIIIIIIllIlIlIIllIl = new SoundRewriter(this);
        llllllllllllllIIIIIIllIlIlIIllIl.registerSound(ClientboundPackets1_14.ENTITY_SOUND);
        llllllllllllllIIIIIIllIlIlIIllIl.registerSound(ClientboundPackets1_14.SOUND);
        ...
        ((AbstractProtocol<C1, C2, S1, ServerboundPackets1_14>)this).registerServerbound(ServerboundPackets1_14.EDIT_BOOK, new PacketRemapper() {
            ...
            public void registerMap() {
                this.handler(lllllllllllllIllIlIlIIlIlIlIIllI -> Protocol1_15To1_14_4.this.itemRewriter.handleItemToServer(lllllllllllllIllIlIlIIlIlIlIIllI.passthrough(Type.FLAT_VAR_INT_ITEM)));
            }
        });
    ...
    @Override
    public void init(final UserConnection llllllllllllllIIIIIIllIlIIlllIIl) {
        this.addEntityTracker(llllllllllllllIIIIIIllIlIIlllIIl, new EntityTrackerBase(llllllllllllllIIIIIIllIlIIlllIIl, Entity1_15Types.PLAYER));
    }
}
