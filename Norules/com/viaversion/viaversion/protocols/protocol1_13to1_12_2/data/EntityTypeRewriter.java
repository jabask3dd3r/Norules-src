...
{
    private static final /* synthetic */ Int2IntMap ENTITY_TYPES;
    
    static {
        (ENTITY_TYPES = new Int2IntOpenHashMap(83, 1.0f)).defaultReturnValue(-1);
        registerEntity(1, 32);
        registerEntity(2, 22);
        registerEntity(3, 0);
        registerEntity(4, 15);
    ...
    public static int getNewId(final int llllllllllllllllIIlIlIlllIlIIlIl) {
        return EntityTypeRewriter.ENTITY_TYPES.getOrDefault(llllllllllllllllIIlIlIlllIlIIlIl, llllllllllllllllIIlIlIlllIlIIlIl);
    }
    
    private static void registerEntity(final int llllllllllllllllIIlIlIlllIlIlIlI, final int llllllllllllllllIIlIlIlllIlIlIIl) {
        EntityTypeRewriter.ENTITY_TYPES.put(llllllllllllllllIIlIlIlllIlIlIlI, llllllllllllllllIIlIlIlllIlIlIIl);
    }
}
