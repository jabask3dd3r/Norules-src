        ...
        ((AbstractProtocol<ClientboundPackets1_9, C2, S1, S2>)this).registerClientbound(ClientboundPackets1_9.SOUND, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(new PacketHandler() {
                    @Override
                    public void handle(final PacketWrapper llIlIIllIIlIIIl) throws Exception {
                        final int llIlIIllIIlIIII = llIlIIllIIlIIIl.get((Type<Integer>)Type.VAR_INT, 0);
                        if (llIlIIllIIlIIII >= 415) {
                            llIlIIllIIlIIIl.set(Type.VAR_INT, 0, llIlIIllIIlIIII + 1);
                        }
                    }
                });
            }
