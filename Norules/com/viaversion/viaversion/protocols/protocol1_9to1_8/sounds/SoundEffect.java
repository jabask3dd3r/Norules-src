...
public enum SoundEffect
{
    ...
    private final /* synthetic */ String newName;
    ...
    STEP_STONE("step.stone", "block.anvil.hit", SoundCategory.NEUTRAL, true), 
    ...
    static {
        ...
        final byte llllllllllllllllllIlIIlIlllIlIIl = (Object)values();
        final int llllllllllllllllllIlIIlIlllIlIII = llllllllllllllllllIlIIlIlllIlIIl.length;
        for (Exception llllllllllllllllllIlIIlIlllIIlll = (Exception)0; llllllllllllllllllIlIIlIlllIIlll < llllllllllllllllllIlIIlIlllIlIII; ++llllllllllllllllllIlIIlIlllIIlll) {
            final SoundEffect llllllllllllllllllIlIIlIlllIlIlI = llllllllllllllllllIlIIlIlllIlIIl[llllllllllllllllllIlIIlIlllIIlll];
            SoundEffect.effects.put(llllllllllllllllllIlIIlIlllIlIlI.getName(), llllllllllllllllllIlIIlIlllIlIlI);
        }
    }
    
    private SoundEffect(final String llllllllllllllllllIlIIllIIIIIIIl, final String llllllllllllllllllIlIIllIIIIIIII, final SoundCategory llllllllllllllllllIlIIlIllllllll, final boolean llllllllllllllllllIlIIlIlllllllI) {
        this.category = llllllllllllllllllIlIIlIllllllll;
        this.newName = llllllllllllllllllIlIIllIIIIIIII;
        this.name = llllllllllllllllllIlIIllIIIIIIIl;
        this.breaksound = (llllllllllllllllllIlIIllIIIIIIIl.startsWith("dig.") || llllllllllllllllllIlIIlIlllllllI);
    }
    
    private SoundEffect(final String llllllllllllllllllIlIIllIIIlIIll, final String llllllllllllllllllIlIIllIIIllIII, final SoundCategory llllllllllllllllllIlIIllIIIlIIIl) {
        this.category = llllllllllllllllllIlIIllIIIlIIIl;
        this.newName = llllllllllllllllllIlIIllIIIllIII;
        this.name = llllllllllllllllllIlIIllIIIlIIll;
        this.breaksound = llllllllllllllllllIlIIllIIIlIIll.startsWith("dig.");
    }
    
    public static SoundEffect getByName(String llllllllllllllllllIlIIlIlllllIll) {
        llllllllllllllllllIlIIlIlllllIll = llllllllllllllllllIlIIlIlllllIll.toLowerCase(Locale.ROOT);
        return SoundEffect.effects.get(llllllllllllllllllIlIIlIlllllIll);
    }
