...
{
    private static final /* synthetic */ Set<String> SPECIAL_ACHIEVEMENTS;
    private static final /* synthetic */ Object2ObjectOpenHashMap<String, String> ACHIEVEMENTS;
    
    public static String get(final String lllllllllllllIllIlllIIllIIIllIII) {
        return AchievementTranslationMapping.ACHIEVEMENTS.get(lllllllllllllIllIlllIIllIIIllIII);
    }
    ...
    private static void add(final String lllllllllllllIllIlllIIllIIlIIIIl, final String lllllllllllllIllIlllIIllIIlIIIlI) {
        AchievementTranslationMapping.ACHIEVEMENTS.put(lllllllllllllIllIlllIIllIIlIIIIl, lllllllllllllIllIlllIIllIIlIIIlI);
    }
    
    public static boolean isSpecial(final String lllllllllllllIllIlllIIllIIIlIlIl) {
        return AchievementTranslationMapping.SPECIAL_ACHIEVEMENTS.contains(lllllllllllllIllIlllIIllIIIlIlIl);
    }
    
    private static void addSpecial(final String lllllllllllllIllIlllIIllIIIllIll, final String lllllllllllllIllIlllIIllIIIlllII) {
        add(lllllllllllllIllIlllIIllIIIllIll, lllllllllllllIllIlllIIllIIIlllII);
        AchievementTranslationMapping.SPECIAL_ACHIEVEMENTS.add(lllllllllllllIllIlllIIllIIIllIll);
    }
}
