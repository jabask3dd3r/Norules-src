    ...
    public void registerPackets() {
        ...
        ((AbstractProtocol<ClientboundPackets1_16, C2, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_16.UNLOCK_RECIPES, new PacketRemapper() {
            ...
            public void registerMap() {
                this.handler(lllllllllllllIlllIlIlIlIIIlIllII -> {
                    lllllllllllllIlllIlIlIlIIIlIllII.passthrough((Type<Object>)Type.VAR_INT);
                    lllllllllllllIlllIlIlIlIIIlIllII.passthrough((Type<Object>)Type.BOOLEAN);
                    lllllllllllllIlllIlIlIlIIIlIllII.passthrough((Type<Object>)Type.BOOLEAN);
                    lllllllllllllIlllIlIlIlIIIlIllII.passthrough((Type<Object>)Type.BOOLEAN);
                    lllllllllllllIlllIlIlIlIIIlIllII.passthrough((Type<Object>)Type.BOOLEAN);
                    lllllllllllllIlllIlIlIlIIIlIllII.write(Type.BOOLEAN, false);
                    lllllllllllllIlllIlIlIlIIIlIllII.write(Type.BOOLEAN, false);
                    lllllllllllllIlllIlIlIlIIIlIllII.write(Type.BOOLEAN, false);
                    lllllllllllllIlllIlIlIlIIIlIllII.write(Type.BOOLEAN, false);
                });
        ...
        ((AbstractProtocol<C1, C2, S1, ServerboundPackets1_16_2>)this.protocol).registerServerbound(ServerboundPackets1_16_2.EDIT_BOOK, new PacketRemapper() {
            @Override
            public void registerMap() {
                this.handler(llllllllllllllIIllIIlIllIIlIIIlI -> InventoryPackets.this.handleItemToServer(llllllllllllllIIllIIlIllIIlIIIlI.passthrough(Type.FLAT_VAR_INT_ITEM)));
            }
        });
        this.registerSpawnParticle(ClientboundPackets1_16.SPAWN_PARTICLE, Type.FLAT_VAR_INT_ITEM, Type.DOUBLE);
    }
    
    public InventoryPackets(final Protocol1_16_2To1_16_1 lllllllllllllIlIlIIllllIllIIIllI) {
        super(lllllllllllllIlIlIIllllIllIIIllI);
    }
}
