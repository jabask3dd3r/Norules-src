        ...
        ((AbstractProtocol<ClientboundPackets1_9, C2, S1, S2>)this).registerClientbound(ClientboundPackets1_9.SOUND, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(new PacketHandler() {
                    @Override
                    public void handle(final PacketWrapper llllllllllllIlllllIlIIlllIIIlIll) throws Exception {
                        final int llllllllllllIlllllIlIIlllIIIlIlI = llllllllllllIlllllIlIIlllIIIlIll.get((Type<Integer>)Type.VAR_INT, 0);
                        if (llllllllllllIlllllIlIIlllIIIlIlI == 415) {
                            llllllllllllIlllllIlIIlllIIIlIll.cancel();
                        }
                        else if (llllllllllllIlllllIlIIlllIIIlIlI >= 416) {
                            llllllllllllIlllllIlIIlllIIIlIll.set(Type.VAR_INT, 0, llllllllllllIlllllIlIIlllIIIlIlI - 1);
                        }
                    }
                });
            }
