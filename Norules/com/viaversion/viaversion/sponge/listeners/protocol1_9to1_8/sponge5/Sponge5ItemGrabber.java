...
{
    @Override
    public ItemStack getItem(final Player lllllllllllllIlIIlllIIIlIlIlllll) {
        return lllllllllllllIlIIlllIIIlIlIlllll.getItemInHand(HandTypes.MAIN_HAND).orElse(null);
    }
}
