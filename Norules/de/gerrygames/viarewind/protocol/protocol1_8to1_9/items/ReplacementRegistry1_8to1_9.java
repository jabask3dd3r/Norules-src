...
{
    private static final /* synthetic */ ReplacementRegistry registry;
    ...
    public static Item replace(final Item llllllllllllllIlIlIlllIIllllIlll) {
        return ReplacementRegistry1_8to1_9.registry.replace(llllllllllllllIlIlIlllIIllllIlll);
    }
    
    public static Replacement getReplacement(final int llllllllllllllIlIlIlllIIlllIlIIl, final int llllllllllllllIlIlIlllIIlllIlIlI) {
        return ReplacementRegistry1_8to1_9.registry.replace(llllllllllllllIlIlIlllIIlllIlIIl, llllllllllllllIlIlIlllIIlllIlIlI);
    }
    
    public static int replace(final int llllllllllllllIlIlIlllIIllllIIII) {
        final int llllllllllllllIlIlIlllIIllllIIlI = BlockState.extractData(llllllllllllllIlIlIlllIIllllIIII);
        final Replacement llllllllllllllIlIlIlllIIllllIIIl = ReplacementRegistry1_8to1_9.registry.replace(BlockState.extractId(llllllllllllllIlIlIlllIIllllIIII), llllllllllllllIlIlIlllIIllllIIlI);
        if (llllllllllllllIlIlIlllIIllllIIIl == null) {
            return llllllllllllllIlIlIlllIIllllIIII;
        }
        return BlockState.stateToRaw(llllllllllllllIlIlIlllIIllllIIIl.getId(), llllllllllllllIlIlIlllIIllllIIIl.replaceData(llllllllllllllIlIlIlllIIllllIIlI));
    }
}
