...
{
    private static final /* synthetic */ HashMap<Integer, String> sounds1_9;
    private static final /* synthetic */ HashMap<String, String> sound1_9to1_8;
    private static /* synthetic */ int id;
    
    private static void registerSoundRemapping(final String lllllllllllllIlIllIIIIIlIllIlllI, final String lllllllllllllIlIllIIIIIlIlllIIII) {
        SoundRemapper.sound1_9to1_8.put(lllllllllllllIlIllIIIIIlIllIlllI, lllllllllllllIlIllIIIIIlIlllIIII);
    }
    
    static {
        sounds1_9 = new HashMap<Integer, String>();
        sound1_9to1_8 = new HashMap<String, String>();
    ...
    public static String getOldName(final String lllllllllllllIlIllIIIIIlIllIIIII) {
        return SoundRemapper.sound1_9to1_8.getOrDefault(lllllllllllllIlIllIIIIIlIllIIIII, lllllllllllllIlIllIIIIIlIllIIIII);
    }
    
    public static String oldNameFromId(final int lllllllllllllIlIllIIIIIlIllIlIIl) {
        final String lllllllllllllIlIllIIIIIlIllIlIII = SoundRemapper.sounds1_9.get(lllllllllllllIlIllIIIIIlIllIlIIl);
        if (lllllllllllllIlIllIIIIIlIllIlIII == null) {
            return null;
        }
        return getOldName(lllllllllllllIlIllIIIIIlIllIlIII);
    }
    
    private static void register1_9Sound(final String lllllllllllllIlIllIIIIIlIlllllII) {
        SoundRemapper.sounds1_9.put(SoundRemapper.id++, lllllllllllllIlIllIIIIIlIlllllII);
    }
}
