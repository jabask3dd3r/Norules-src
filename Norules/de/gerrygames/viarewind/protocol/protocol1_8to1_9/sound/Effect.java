...
public class Effect
{
    private static final /* synthetic */ HashMap<Integer, Integer> effects;
    
    public static int getOldId(final int llllllllllllllIIlllIllIIlIIIIIII) {
        return Effect.effects.getOrDefault(llllllllllllllIIlllIllIIlIIIIIII, llllllllllllllIIlllIllIIlIIIIIII);
    }
    
    static {
        (effects = new HashMap<Integer, Integer>()).put(1003, 1002);
