...
public class ReplacementRegistry1_7_6_10to1_8
{
    ...
    public static int replace(final int lIIIIllIllII) {
        final int lIIIIllIlIll = BlockState.extractData(lIIIIllIllII);
        final Replacement lIIIIllIlIlI = ReplacementRegistry1_7_6_10to1_8.registry.replace(BlockState.extractId(lIIIIllIllII), lIIIIllIlIll);
        return (lIIIIllIlIlI != null) ? BlockState.stateToRaw(lIIIIllIlIlI.getId(), lIIIIllIlIlI.replaceData(lIIIIllIlIll)) : lIIIIllIllII;
    }
    ...
    public static Replacement getReplacement(final int lIIIIllIIlII, final int lIIIIllIIIIl) {
        return ReplacementRegistry1_7_6_10to1_8.registry.replace(lIIIIllIIlII, lIIIIllIIIIl);
    }
    
    public static Item replace(final Item lIIIIlllIIII) {
        return ReplacementRegistry1_7_6_10to1_8.registry.replace(lIIIIlllIIII);
    }
}
