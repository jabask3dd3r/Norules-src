...
public class Ticker
{
    ...
    public static void init() {
        ...
        Via.getPlatform().runRepeatingSync(() -> Via.getManager().getConnectionManager().getConnections().forEach(lllllllllllllIlllIIIlIlllIlIIlII -> {
            lllllllllllllIlllIIIlIlllIlIIlII.getStoredObjects().values().stream();
